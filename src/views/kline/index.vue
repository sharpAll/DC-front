<template>
  <div class="w-full h-full component-content">
    <div class="flex h-full">
      <div class="w-40px flex-shrink-0 border-gray-200 border-r pt-10px text-center">
        <n-tooltip trigger="hover" placement="right">
          <template #trigger>
            <n-button text style="font-size: 34px" @click="setShapeType('priceLine')">
              <n-icon>
        ...
        <n-tooltip trigger="hover" placement="right">
          <template #trigger>
            <n-button text style="font-size: 34px" @click="setShapeType('straightLine')">
              <n-icon>
                <svg viewBox="0 0 24 24">
        ...
        <n-tooltip trigger="hover" placement="right">
          <template #trigger>
            <n-button text style="font-size: 34px" @click="setShapeType('parallelStraightLine')">
              <n-icon>
                <svg viewBox="0 0 24 24">
        ...
        <n-tooltip trigger="hover" placement="right">
          <template #trigger>
            <n-button text style="font-size: 34px" @click="setShapeType('priceChannelLine')">
              <n-icon>
                <svg viewBox="0 0 24 24">
        ...
        <n-tooltip trigger="hover" placement="right">
          <template #trigger>
            <n-button text style="font-size: 34px" @click="setShapeType('fibonacciLine')">
              <n-icon>
                <svg viewBox="0 0 24 24">
        ...
        <n-tooltip trigger="hover" placement="right">
          <template #trigger>
            <n-button text style="font-size: 34px" @click="setShapeType('rect')">
              <n-icon>
        ...
        <n-tooltip trigger="hover" placement="right">
          <template #trigger>
            <n-button text style="font-size: 34px" @click="setShapeType('circle')">
              <n-icon>
      ...
      <div class="flex-auto flex flex-col relative">
        <div class="py-3px pl-10px border-gray-200 border-b">
          <n-space>
            <n-button text size="large" @click="openIndexModal"><template #icon>
                <n-icon>
                  <LineChartOutlined />
                </n-icon> </template>指标</n-button>
            <n-switch v-model:value="dealActive" class="mt-5px" @update:value="annotationCheck">
              <template #checked>交易点</template>
              <template #unchecked>交易点</template>
            </n-switch>
            <n-switch v-model:value="eventActive" class="mt-5px" @update:value="annotationCheck">
        ...
        <div v-show="isDetailListShow" class="h-300px flex-shrink-0 border-gray-200 border-t">
          <DetailList @close="closeDetailList" />
        </div>
        <div v-show="!isDetailListShow" class="absolute bottom-3px right-11px z-99">
          <n-button circle size="small" @click="showDetailList">
            <template #icon>
              <n-icon>
                <ArrowUpOutlined />
              </n-icon>
    ...
    <n-modal v-model:show="showIndexModal" display-directive="show" :show-icon="false" preset="dialog" title="指标"
      style="width: 400px; height: 550px">
      <IndexForm @add-index="addIndex" @remove-index="removeIndex" @add-sub-index="addSubIndex"
        @remove-sub-index="removeSubIndex" />
    </n-modal>
    <n-modal v-model:show="showEventModal" :show-icon="false" preset="dialog" :title="eventTime"
...
import { ArrowUpOutlined, LineChartOutlined } from "@vicons/antd";
...
const isDetailListShow = ref(true);
